...
%crdJul13 -- ok, I wrote something at lines 251-254 on this, but I am afraid to report results that overlap with 0 for this, but not consistently for the other model parameters. What do you think?  Should we just report an average across all species? I didn't talk about 2020 or 2022 as the difference is so weak, that I don't think it's worth reporthing OR should we just say there is no difference across years, even when there were droughts?
...
We also found no clear trends with ring porosity. {\Ball} and {\Bnig}, which showed the contrasting responses described above were both diffuse-porous and the five other diffuse-porous species did not increase growth with longer or warmer seasons. We had only four ring-porous species but they did not stand out at all. While this is a small sample, it supports recent work \citep[e.g.,][]{grover_growth_2023} suggesting ring porosity may not be as useful a predictor for growth as previously suggested \citep{wang_relation_1992}. While porosity impose inherent physiological differences across species, explaning growth drivers with this dichotomous classification may be an over-simplication of the reality. In fact, gradient of growth speed and tree longitivity may be influenced by wood porosity, but the way wood porosity acts as a driver of life history strategies may be through a gradient of fast to slow growth where both diffuse and ring-porous species can belong in them. This emphasizes the need to better classify growth traits and related carbon allocation with wood porosity. % fix this
