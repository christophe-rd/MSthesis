...
\item Introduction
  \begin{enumerate}
  \item ACC impacts on tree phenology
    \begin{enumerate}
    \item Spring are earlier
    \item Autumn delayed
    \item Lenghtens the GSL
    \item (Figure): simplified version of conceptual figure?
    \end{enumerate}
    
  \item Long GS should = more growth
    \begin{enumerate}
